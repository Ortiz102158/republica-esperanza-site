cat > /tmp/crear_ensayo_diaspora.py << 'PYEOF'
...
- Banco Central de la República Dominicana. (2024). Informe de Remesas Familiares 2023. Santo Domingo: BCRD.
- Banco de España. (2024). Estadísticas de Remesas Internacionales. Madrid: Banco de España.
...
- OCDE. (2023). International Migration Outlook. París: OECD Publishing.
- Pew Research Center. (2023). "Dominicans in the United States: Key Facts". Washington, D.C.: Pew Research Center.
...
salida = Path.home() / 'republica-esperanza-site' / 'periodico' / 'content' / 'diaspora' / 'la-diaspora-dominicana.md'
salida.write_text(contenido, encoding='utf-8')
print("OK: Ensayo de la diaspora creado")
print("Tamano: " + str(len(contenido)) + " bytes")
print("Guardado en: " + str(salida))
PYEOF

python3 /tmp/crear_ensayo_diaspora.py
